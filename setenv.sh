...
export LXQT_STAGE3="lxqt-about-0.7.0.tar.gz lxqt-common-0.7.0.tar.gz lxqt-config-0.7.0.tar.gz lxqt-lightdm-greeter-0.7.0.tar.gz lxqt-notificationd-0.7.0.tar.gz lxqt-openssh-askpass-0.7.0.tar.gz lxqt-policykit-0.7.0.tar.gz lxqt-powermanagement-0.7.0.tar.gz lxqt-qtplugin-0.7.0.tar.gz lxqt-session-0.7.0.tar.gz"
